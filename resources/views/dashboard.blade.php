...
<head>
    ...
    <title>Dashboard Pak Budi</title>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo ($pemasukan[0]->pemasukan == null) ? 0 : $pemasukan[0]->pemasukan; ?>  <a class="btn btn-primary" href="{{ route('masuk') }}" role="button">detail</a></td>
                                </tr>
                                <tr>
                        ...
                        <a class="btn btn-primary" href="{{ route('pemasukan.create') }}" role="button">Tambah
                            pemasukan</a>
                        <a class="btn btn-primary" href="{{ route('pengeluaran.create') }}" role="button">Tambah
                            pengeluaran</a>

                        <a class="btn btn-primary" href="{{ route('dashboardanak') }}" role="button">Dashboard anak</a>
                    </div>
                </div>
            </div>
        </div>
